...
test("invalid settings fall back independently",()=>assert.deepEqual(normalizeSettings({batchSize:"nope",pauseSeconds:12,maximumBackoff:"nope"}),{batchSize:5,pauseSeconds:12,useBackoff:true,maximumBackoff:600}));
